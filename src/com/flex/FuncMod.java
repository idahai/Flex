...
public class FuncMod {
	...
	public void downloadPictures(String[] urls) {
		for (String eachPic : urls) {
			...
			if (picis == null) {
				LogU.Log(tag, picrmUrl + "读取失败");
			} else {
				LogU.Log(tag, picrmUrl + "读取成功");
